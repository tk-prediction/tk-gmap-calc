...
if __name__ == '__main__':
    ...
    if config['Model']['check_predict'] == "check":
        ViewPredict.view_predict( z_pred , 0 , 4 , 100 , 1000 , "check" )     
    
    elif config['Model']['check_predict'] == "output" :
        ViewPredict.view_predict( z_pred , 0 , 4 , 100 , 1000 , "output" )             
    ...
    if config['Model']['check_predict'] == True and config['Model']['check_dmdmode'] == True:
        ...
        #pred
        ViewPredict.view_predict( np.real(dmd_pred ) , 0 , 1 , 300 , 1000 , "check" )
